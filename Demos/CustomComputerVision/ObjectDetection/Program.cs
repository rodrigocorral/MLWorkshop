...
namespace ObjectDetection
{
    class Program
    {
        ...
        const string ENDPOINT = "https://customvisionrcg.cognitiveservices.azure.com/";

        // Add your training & prediction key from the settings page of the portal
        const string trainingKey = "6d3fbe23f7ad41b7b284387211bf4611";
        const string predictionKey = "6d3fbe23f7ad41b7b284387211bf4611";

        const string publishedModelName = "toolModel";
        const string predictionResourceId = "f2fc611f-1a66-4ec0-8f79-65fb51146af9";

        static void Main(string[] args)
        {
            // <snippet_maincalls>
            CustomVisionTrainingClient trainingApi = AuthenticateTraining(ENDPOINT, trainingKey, predictionKey);
        ...
        private static void UploadImages(CustomVisionTrainingClient trainingApi, Project project)
        {
            ...
            var imageBasePath = "/Users/rcorral/Desktop/ML & IA For Developers/Final/Code/cognitive-services-sample-data-files/CustomVision/ObjectDetection/Images";

            // Add all images for fork
            var imagePath = Path.Combine(imageBasePath, "fork");
            ...
            imagePath = Path.Combine(imageBasePath, "scissors");
